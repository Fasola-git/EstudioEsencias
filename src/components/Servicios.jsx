        ...
        <section className="Servicios" id="Servicios" >
            ...
            <div className='ContentContainer'>
                <div className='Background'>
                    <img src="/EstudioEsencias/img/Linea-Servicios.png" alt="fondoservicios" />
                </div>
                <div className='CaruselContainer'>
                    ...
                    <div className='Carusel'>
                        <div className='CaruselItemExtendido' id='c1'>
                            <div className='CaruselItem'>
                                <div className='CaruselContent'>
                                    <img src="/EstudioEsencias/img/ProduccionMusical.jpeg" alt="produccionmusical" />
                        ...
                        <div className='CaruselItemExtendido' id='c2'>
                            <div className='CaruselItem'>
                                <div className='CaruselContent'>
                                    <img src="/EstudioEsencias/img/REC.jpeg" alt="rec" />
                                    <div className='CaruselTexto'>
                                        <div className='DivTexto'>
                        ...
                        <div className='CaruselItemExtendido' id='c3'>
                            <div className='CaruselItem'>
                                <div className='CaruselContent'>
                                    <img src="/EstudioEsencias/img/RegistroYGestion.jpeg" alt="registroygestion" />
                                    <div className='CaruselTexto'>
                                        <div className='DivTexto'>
